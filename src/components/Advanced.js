...
export default class Advanced extends React.Component {
  ...
  render () {
    const { isVendor, balance, privateKey, changeAlert, setPossibleNewPrivateKey } = this.props
    ...
    const inputPrivateKeyRow = (
      <div className='content ops row'>
        <div className={inputPrivateSize}>
          <input
            type={this.state.privateKeyHidden ? 'password' : 'text'} autoCorrect='off' autoCapitalize='none' className='form-control' placeholder='private key' value={this.state.newPrivateKey}
        ...
        <div className='col-6 p-1'>
          <button
            className='btn btn-large w-100' style={this.props.buttonStyle.primary}
            onClick={() => {
    ...
    const inputSeedRow = (
      <div className='content ops row' style={{ paddingTop: 10 }}>
        <div className={inputSeedSize}>
          <input
            type={this.state.seedPhraseHidden ? 'password' : 'text'} autoCorrect='off' autoCapitalize='none' className='form-control' placeholder='seed phrase' value={this.state.newSeedPhrase}
    ...
    return (
      <div style={{ marginTop: 20 }}>
        ...
        {privateKey && !isVendor &&
          <div>
            ...
            <div className='content ops row' style={{ marginBottom: 10 }}>
              ...
              <div className='col-6 p-1'>
                <button
                  className='btn btn-large w-100' style={this.props.buttonStyle.secondary} onClick={() => {
        ...
        <div className='content ops row'>
          <div className='col-6 p-1'>
            <input
              type='text' autoCorrect='off' autoCapitalize='none' className='form-control' placeholder='any text to encode' value={this.state.newQr}
              onChange={event => this.setState({ newQr: event.target.value })}
            />
          </div>
          <div className='col-6 p-1'>
            <button
              className='btn btn-large w-100' style={this.props.buttonStyle.secondary}
              onClick={() => {
