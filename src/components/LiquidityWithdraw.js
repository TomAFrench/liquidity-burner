  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        <Ruler/>
        Withdrawal Limit: {typeof this.props.withdrawLimit !== 'undefined' ? fromWei(this.props.withdrawLimit.toString(), 'ether').toString() : 0} {this.props.text}
        <br/>
        Withdrawal Fee: {typeof this.props.withdrawLimit !== 'undefined' ? fromWei(this.props.withdrawFee.toString(), 'ether').toString() : 0} ETH
