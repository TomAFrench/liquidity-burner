...
export default class LiquidityReceive extends React.Component {
  ...
  render() {
    let {dollarDisplay,view,buttonStyle,ERC20TOKEN, address, changeAlert, changeView, subBalanceDisplay,account, hubContract, hubApiUrl} = this.props
      ...
      <div>
        <div className="send-to-address w-100">
          ...
          <div style={{width:"100%",textAlign:'center',padding:20}}>
            <a href={"https://explorer.liquidity.network/?#/explorer?token=" + hubContract + "&address=" + address + "&url=" +hubApiUrl} target="_blank">
              View on Explorer
            </a>
          </div>
